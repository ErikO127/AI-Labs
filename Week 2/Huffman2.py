...
if __name__ == "__main__":
    ...
    with open("compress_words.txt", "wb") as file:
        file.write(bytes(byte_array))
        pickle.dump(root, file) 

    print("Compression complete. Encoded data written to 'compress_words.txt'.")

    with open("compress_words.txt", "rb") as file:
        byte_data = file.read(len(byte_array))
